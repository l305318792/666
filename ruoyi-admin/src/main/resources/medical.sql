...
-- 1. 用户表扩展
-- ----------------------------
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS user_type char(1) COMMENT '用户类型(0管理员 1医生 2患者)';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS real_name varchar(50) COMMENT '真实姓名';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS id_card varchar(18) COMMENT '身份证号';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS phone varchar(11) COMMENT '手机号码';
